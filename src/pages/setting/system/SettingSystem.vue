  ...
  <t-card size="small">
    ...
    <t-card>
      <t-list size="small" split>
        <t-list-item>
          <t-list-item-meta title="生成数据的存储路径" description="生成数据的存储目录（短片标记，短片预览，预览图等）"/>
          <template #action>
        ...
        <t-list-item>
          <t-list-item-meta title="缓存路径"
                            description="缓存的目录位置。如果使用 HLS（例如在 Apple 设备上）或 DASH 进行流传输，则需要该位置。"/>
          <template #action>
            <t-button theme="primary" @click="onPathEdit('cachePath')">编辑</t-button>
          </template>
        </t-list-item>
        <t-list-item>
          <t-list-item-meta title="刮削器路径" description="含有刮削器配置文件的路径"/>
          <template #action>
            <t-button theme="primary" @click="onPathEdit('scraperPath')">编辑</t-button>
          </template>
        </t-list-item>
        <t-list-item>
          <t-list-item-meta title="插件文件路径" description="插件配置文件目录"/>
          <template #action>
            <t-button theme="primary" @click="onPathEdit('pluginPath')">编辑</t-button>
          </template>
        </t-list-item>
        <t-list-item>
          <t-list-item-meta title="元数据存储路径" description="整体导出或者导入时使用的路径"/>
          <template #action>
            <t-button theme="primary" @click="onPathEdit('metaPath')">编辑</t-button>
          </template>
        </t-list-item>
        <t-list-item>
          <t-list-item-meta title="自定义演员图像路径" description="默认演员图像的自定义路径。留空以使用内置默认值"/>
          <template #action>
        ...
        <t-list-item>
          <t-list-item-meta title="备份用的路径" description="备份SQLite 数据库文件的目录路径"/>
          <template #action>
