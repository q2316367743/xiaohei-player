...
export type AuthType = 'auto' | 'digest' | 'none' | 'password' | 'token';
...
export type CreateWriteStreamCallback = (response: AxiosResponse) => void;
...
export type DAVResultResponse =
  DAVResultBaseResponse
...
export type RequestOptionsCustom = RequestOptionsBase
...
export type ResponseData = string | Buffer | ArrayBuffer | Array<any>;
...
export interface WebDAVClient {
  ...
  putFileContents: (filename: string, data: string | BufferLike | WritableStream, options?: PutFileContentsOptions) => Promise<boolean>;
